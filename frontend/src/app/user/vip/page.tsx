...
import { Heart, Plus, History, Bell, User, LogOut, Loader2, AlertCircle, Sparkles } from "lucide-react";
    ...
    return (
      <div className="min-h-[70vh] bg-black text-white flex flex-col items-center justify-center gap-4 px-6 text-center select-none">
        ...
        <p className="text-sm text-zinc-500 max-w-sm">
          Đăng nhập tài khoản DlowPhim để nâng cấp quyền lợi thành viên VIP.
        </p>
        <button
          onClick={() => {
            if (typeof window !== "undefined") {
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full lg:w-[280px] bg-[#12131b] border border-zinc-800/40 rounded-3xl p-6 flex flex-col justify-between shrink-0 select-none">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  <div className="flex items-center justify-center w-[18px] h-[18px] text-[10px] font-black border border-pink-500 rounded-md shrink-0 text-pink-500">VIP</div>
          ...
          <div className="flex-1 w-full space-y-6">
            ...
            <div className="bg-[#12131b]/30 border border-zinc-900 rounded-3xl py-20 px-8 flex flex-col items-center justify-center gap-3 select-none text-center">
              ...
              <h4 className="text-base font-bold text-zinc-400">Gói VIP Đang Được Thiết Kế</h4>
              <p className="text-xs text-zinc-500 max-w-xs">
                Tính năng thanh toán và đặc quyền VIP đang được hoàn thiện. Hãy đón chờ ở các bản cập nhật tiếp theo!
              </p>
            </div>
          </div>
